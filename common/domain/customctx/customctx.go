...
type WrapError struct {
	Error  pperrs.CustomErrorInterface `json:"error"`
...
func (c *CustomContext) addError(err pperrs.CustomErrorInterface, call_in string) {
	if err == nil {
		return
	}
	c.mu.Lock()
...
func (c *CustomContext) NewError(err pperrs.CustomErrorInterface) pperrs.CustomErrorInterface {
